...
blat %content% -attach %ATTACH_RESULT% -attach %ATTACH_DB_SCRIPT_LOG% -f %SENDFROM% -to %SENDTOAdmin% -server %MAILSERVERNAME% -subject "For Admin :: Trial Tracker status : %subject% has unexpected error ( %2 )."
GOTO E_CLOSE_S
:G_EXCEPTION
