...
blat %content% -attach %ATTACH_RESULT% -attach %ATTACH_DB_SCRIPT_LOG% -f %SENDFROM% -to %SENDTO% -cc %CCMail% -server %MAILSERVERNAME% -subject "Trial Tracker Batch completed successfully ( %2 )."  -log %logname%
